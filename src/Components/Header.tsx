      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={profileMenuRef}>
            ...
            >
              {/* Avatar with conditional golden ring */}
              <div className="relative w-8 h-8">
                <div className={`w-8 h-8 bg-gradient-to-br from-blue-500 to-teal-500 rounded-full flex items-center justify-center ${
                  showBadge ? 'ring-2 ring-amber-400' : ''
                }`}>
                  <User className="w-4 h-4 text-white" />
                </div>
                {/* Tier badge */}
                {showBadge && badge && (
                  <span className={`absolute -bottom-2 left-1/2 -translate-x-1/2 text-[9px] px-1.5 rounded-full leading-tight shadow-md whitespace-nowrap ${badge.className}`}>
                    {badge.label}
                  </span>
                )}
              </div>
              ...
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50">
                ...
                <div className="px-4 py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    {/* Larger avatar with conditional golden ring */}
                ...
                <div className="py-2">
                  <button
                    onClick={() => { setShowProfileMenu(false); setActiveTab('settings' as TabId); }}
